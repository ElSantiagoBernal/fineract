...
export FINERACT_HIKARI_JDBC_URL="jdbc:postgresql://fineract-postgres.cvce662ao29a.us-east-2.rds.amazonaws.com:5432/fineract_tenants"
export FINERACT_HIKARI_USERNAME="fineractuser"
export FINERACT_HIKARI_PASSWORD="Santiibernal10"
